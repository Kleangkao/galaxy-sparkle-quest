...
export default function SpaceBackground() {
  ...
  return (
    <div className="space-background fixed inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
      {/* Stars */}
      {stars.map((s) => (
        <div
          key={s.id}
      ...
      />
      <div
        className="space-background__nebula absolute top-[45%] right-[8%] w-[28rem] h-[28rem] rounded-full"
        style={{
