...
export default function PuriBondPanel({ bond }: { bond: number }) {
  ...
  return (
    <section className="puri-panel" aria-label="PURI bond progression">
      <div className="puri-panel__companion"><img src="/assets/galia-soft-tech/puri-companion-v1.png" alt="PURI" /><div><span>Your adventure buddy</span><h2>PURI · {progress.current.name}</h2><p>{progress.current.ability}: {progress.current.description}</p></div></div>
