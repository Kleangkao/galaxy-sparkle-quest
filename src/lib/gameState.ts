...
export const SHIP_UPGRADES: ShipUpgrade[] = [
  ...
  { id: "scanner", name: "Crystal Scanner", nameTh: "เครื่องสแกนคริสตัล", emoji: "📡", description: "Permanent reward scanner for every mode.", descriptionTh: "ระบบค้นหาคริสตัลที่ใช้ได้กับทุกโหมด", effect: "+15% crystals from every activity.", effectTh: "รับคริสตัลจากทุกโหมดเพิ่ม 15%", cost: 40, requiredLevel: 3 },
  { id: "garden", name: "Xenobiology Habitat", nameTh: "ศูนย์ชีววิทยาต่างดาว", emoji: "🌿", description: "Permanent companion habitat support.", descriptionTh: "พื้นที่ดูแลเพื่อนร่วมทางบนยาน", effect: "+15% alien companion discovery chance.", effectTh: "โอกาสพบเพื่อนต่างดาวเพิ่ม 15%", cost: 50, requiredLevel: 4 },
  { id: "wings", name: "Star Wings", nameTh: "ปีกดวงดาว", emoji: "🦋", description: "Permanent high-rank route tuning.", descriptionTh: "ระบบช่วยให้ภารกิจมีเวลาเพิ่ม", effect: "+8 seconds in Story, Swarm, and Arcade.", effectTh: "เพิ่มเวลา 8 วินาทีในเนื้อเรื่อง ฝ่าฝูง และยิงเป้า", cost: 80, requiredLevel: 6 },
  { id: "crown", name: "Galaxy Crown", nameTh: "มงกุฎกาแล็กซี่", emoji: "👑", description: "Permanent reward relic for every mode.", descriptionTh: "ของล้ำค่าที่เพิ่มรางวัลจากทุกโหมด", effect: "+20% crystals from every activity.", effectTh: "รับคริสตัลจากทุกโหมดเพิ่ม 20%", cost: 120, requiredLevel: 8 },
];
...
export const SECTOR_LORE: Record<string, SectorLore> = {
  ...
  "candy-planet": { name: "Kora Wilds", chapter: "02 · Living Signal", threat: "Mimic spores", story: "The signal is alive. It wants you to follow.", mission: "Track a playful lifeform through glowing coral forests." },
