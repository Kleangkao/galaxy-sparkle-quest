...
export const ALIEN_PETS: AlienPet[] = [
  {
    ...
    ability: { type: "crystal-boost", descEn: "+10% crystals", descTh: "รับคริสตัลเพิ่ม 10%", emoji: "💎" },
  },
  {
    ...
    ability: { type: "discovery", descEn: "+8% companion discovery chance", descTh: "โอกาสพบเพื่อนร่วมทางเพิ่ม 8%", emoji: "🔍" },
  },
  {
    ...
    ability: { type: "crystal-boost", descEn: "+20% crystals", descTh: "รับคริสตัลเพิ่ม 20%", emoji: "💎" },
  },
  {
    ...
    ability: { type: "extra-time", descEn: "+3 seconds in timed modes", descTh: "โหมดจับเวลามีเวลาเพิ่ม 3 วินาที", emoji: "⏱️" },
  },
  {
    ...
    ability: { type: "discovery", descEn: "+25% companion discovery chance", descTh: "โอกาสพบเพื่อนร่วมทางเพิ่ม 25%", emoji: "🌟" },
  },
  {
    ...
    ability: { type: "crystal-boost", descEn: "+15% crystals", descTh: "รับคริสตัลเพิ่ม 15%", emoji: "💎" },
  },
  {
    ...
    ability: { type: "extra-time", descEn: "+5 seconds in timed modes", descTh: "โหมดจับเวลามีเวลาเพิ่ม 5 วินาที", emoji: "⏱️" },
  },
  {
  ...
  },
  {
    ...
    ability: { type: "extra-time", descEn: "+4 seconds in timed modes", descTh: "โหมดจับเวลามีเวลาเพิ่ม 4 วินาที", emoji: "⏱️" },
  },
  {
    ...
    rarity: "rare", color: "text-cosmic-purple",
    ability: { type: "discovery", descEn: "+15% companion discovery chance", descTh: "โอกาสพบเพื่อนร่วมทางเพิ่ม 15%", emoji: "🌟" },
  },
];
